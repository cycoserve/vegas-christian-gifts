          ...
          <div className="mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
              <Link href={'/'} className=" bg-white rounded-md shadow-md p-2">
                ...
                <p className="text-[0.8rem] text-zinc-600 mb-4 line-clamp-2">{description1}</p>
              </Link>
              <Link href={'/'} className=" bg-white rounded-md shadow-md p-2">
                <Image
                  className="w-full rounded-lg mb-4 aspect-video"
                ...
                <p className="text-[0.8rem] text-zinc-600 mb-4 line-clamp-2">{description2}</p>
              </Link>
              <Link href="/" className=" bg-white rounded-md shadow-md p-2">
                <Image
                  className="w-full rounded-lg mb-4 aspect-video"
                ...
                <p className="text-[0.8rem] text-zinc-600 mb-4 line-clamp-2">{description3}</p>
              </Link>
            </div>
          </div>
        </section>
